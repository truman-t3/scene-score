...
**v0.2 evidence / v0.2 证据：** [`rain-street-v0.2-score.jpg`](../examples/rain-street-v0.2-score.jpg) · [run note](v0.2-validation.md#01--rain-street--雨街)
...
**v0.2 evidence / v0.2 证据：** [`stair-hall-v0.2-bright-score.jpg`](../examples/stair-hall-v0.2-bright-score.jpg) · [run note](v0.2-validation.md#02--stair-hall--阶梯大厅)
...
**v0.2 evidence / v0.2 证据：** [`misty-ginkgo-score.jpg`](../examples/misty-ginkgo-score.jpg) · [run note](v0.2-validation.md#03--misty-ginkgo--雾湖银杏)
